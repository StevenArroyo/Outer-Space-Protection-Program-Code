...
public class EnemyHealth_Commander_Atmos : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (health <= 0)
        {
            ...
            GameObject.FindWithTag("Spawner").GetComponent<EnemyWaveSpawnwer_SS_Atmos>().EnemyTracker(1);
