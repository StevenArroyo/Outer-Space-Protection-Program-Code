...
public class EnemyHealth_Demon : MonoBehaviour {
    ...
    void Update()
    {
		...
		if (health <= 0) {
            ...
            GameObject.FindWithTag("Base").GetComponent<BaseHealth>().TriggerWin();
            ...
            if(Time.time > NextSpawn)
            {
                ...
                switch (whattoSpawn)
                {
                    ...
                    GameObject.FindWithTag("Spawner").GetComponent<EnemyWaveSpawner_SS>().EnemyTracker(1);
