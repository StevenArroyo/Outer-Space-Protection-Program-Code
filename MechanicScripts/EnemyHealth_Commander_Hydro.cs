...
public class EnemyHealth_Commander_Hydro : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (health <= 0)
        {
            ...
            GameObject.FindWithTag("Spawner").GetComponent<EnemyWaveSpawner_SS_Hydro>().EnemyTracker(1);
